package com.projectoSpring.springboot.backend.apirest.auth.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.projectoSpring.springboot.backend.apirest.auth.SimpleGrantedAuthorityJsonCreator;
...
import static com.projectoSpring.springboot.backend.apirest.auth.TokenJwtConfig.*;
...
public class JwtValidationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            body.put("message", "El Token no es invalido!");
